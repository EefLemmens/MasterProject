...
#input files
inputfile = 'Only Outliers Number Of Case Variant BPI2012.csv'
...
if inputfile == 'Only Outliers Number Of Case Variant BPI2012.csv':
    caseID = []
    activity = []
    resource = []
    completetimestamp = []
...
if inputfile == 'Only Outliers Number Of Case Variant BPI2017.csv':
    caseID = []
    activity = []
    resource = []
    starttimestamp = []
...
if inputfile == 'Only Outliers Number Of Case Variant Sepsis.csv':
    caseID = []
    activity = []
    completetimestamp = []
    Variantcase = []
...
if inputfile == 'Only Outliers Number Of Case Variant Road Traffic Fine.csv':
    caseID = []
    activity = []
    Resource = []
    completetimestamp = []
...
if inputfile == 'Only Outliers Number Of Case Variant Hospital Log.csv':
    caseID = []
    activity = []
    completetimestamp = []
    variantcase = []
...
if inputfile == 'Only Outliers Number Of Case Variant Hospital Billing.csv':
    caseID = []
    activity = []
    resource = []
    completetimestamp = []
...
with open('Outliers file Number Of Case Variant BPI2012.csv','w', newline ='') as f:
    writer = csv.writer(f)
    temp = []
...
with open('NonOutliers file Number Of Case Variant BPI2012.csv', 'w', newline='') as f:
    writer = csv.writer(f)
    temp = []
    for i in range(0,len(firstline)):
        temp.append(firstline[i])
